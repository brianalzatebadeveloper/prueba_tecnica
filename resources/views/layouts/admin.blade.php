...
<div class="container body">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                    <a href="{{ route('admin.logout') }}"><i class="fa fa-sign-out pull-right"></i> Salir </a>
 ...
 <script type="text/javascript">
      ...
      var urlRefresh = "{{ route('refresh.contacts') }}";
      var urlValidate = "{{ route('validate.refresh') }}";
      var _token = $('#formRefresh :input[name=_token]').val();
        ...
        setInterval(function(){
            ...
            $.ajax({
              ...
              success: function(response)
              {
                  ...
                  {
                      refreshMembers();
                      active(response.contacts,response.cont);
                  }
